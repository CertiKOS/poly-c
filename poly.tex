...
We represent low-level programs as graphs with
labelled arrows.  The set of graph vertices
...
$$
\cnf{\state_1}{v_1} \smallstep_q \cnf{\state_2}{v_2}
  \iff
(v_1, f, q, v_2) \in E  \land  \state_2 = f(\state_1).
$$
...
from the initial configuration ends with a \emph{normal configuration}:
A configuration that cannot transition to any other
configurations.  We can formalize this notion in Coq
