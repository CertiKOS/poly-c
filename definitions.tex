...
% USED FOR SURE
\newcommand{\Quentin}[1]{\textcolor{red}{#1}}
\newcommand{\Vrt}[0]{\ensuremath{\mathcal V}}
\newcommand{\Edg}[0]{\ensuremath{\mathcal E}}
\newcommand{\act}[0]{\ensuremath{\mathsf{act}}}
\newcommand{\cnf}[2]{\ensuremath{#1\,@\,#2}}
\newcommand{\safe}[3]{\ensuremath{\mathit{safe}_E(\cnf{#1}{#2}, #3)}}
